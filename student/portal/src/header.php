<header class="fixed w-full min-h-[70px] bg-white/90 flex items-center justify-between">
    <div class="pl-[230px] w-[95%] flex justify-end gap-6 h-custom-screen-mm:pl-0">
        <div class="flex items-center"><p>Welcome! <span id="welcome_name"></span></p></div>
...
<nav class="fixed w-[230px] h-screen bg-black/90 text-white h-custom-screen-mm:hidden">
    ...
    <ul>
        <li class="side-links" onclick="_get_page('dashboard')"><i class="bi-speedometer2 mr-[6px]"></i> Dashboard</li>
        <li class="side-links" onclick="_expand_link('fees');" title="Fees" id=""><i class="bi-book mr-[6px]"></i> Fees<i class="bi bi-chevron-down float-right mr-[15px]"></i>
            <div class="w-[100%] bg-white/50" id="fees-li" style="display:none">   
                <div class="li-in" onclick="_get_page('payment-history');"> - Payment History</div>
                <div class="li-in" onclick="_get_page('payment-advice');"> - Payment Advise</div>
            </div>
        </li>
