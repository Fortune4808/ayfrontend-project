<?php if($page=='log-in'){?>
    ...
    <div class="block log-div" id="next_1">
        ...
        <div class="mt-[20px] font-bold text-[12px] flex flex-col gap-[18px]">
            <div class="w-[100%]">
                <label class="px-[10px] text-secondary-color"><i class="bi-envelope-fill text-[#A4A6C5]"></i> MATRIC NUMBER:</label><br/>
                <input class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" type="text" id="matric" placeholder="ENTER YOUR MATRIC NUMBER"/>
            </div>
            
            <div class="w-[100%]">
                <label class="px-[10px] text-secondary-color"><i class="bi-vinyl text-[#A4A6C5]"></i> PASSWORD:</label><br/>
                <input class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" type="password" id="login_pass" placeholder="ENTER YOUR PASSWORD"/>
            </div>

            <button class="w-[40%] bg-primary-color hover:bg-[#444444] text-white py-[15px] rounded-[5px]" title="Login" id="submit_btn" onclick="_log_in()">LOG-IN <i class="bi-check2"></i></button>
        </div>
    ...
    <div class="hidden log-div" id="next_3">
        <div class="mt-[20px] font-bold text-[12px] flex flex-col gap-[18px]">
            <div class="w-[100%]">
                ...
                <input class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" type="text" id="matric_no" placeholder="MATRIC NUMBER"/>
            </div>
            ...
            <div class="w-[100%]">
                ...
                <input class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" type="text" id="middle_name" placeholder="MIDDLE NAME"/>
            </div>

            <div class="w-[100%]">
                <label class="px-[10px] text-secondary-color">LAST NAME:</label><br/>
                <input class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" type="text" id="last_name" placeholder="LAST NAME"/>
            </div>
            ...
            <div class="w-[100%]">
                <label class="px-[10px] text-secondary-color">PARENT/GUARDIAN PHONE NUMBER:</label><br/>
                <input class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" type="tel" id="p_mobileno" placeholder="PARENT/GUARDIAN PHONE NUMBER"/>
            </div>

            <div class="w-[100%]">
                <label class="px-[10px] text-secondary-color">DATE OF BIRTH:</label><br/>
                <input class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" type="date" id="dob" placeholder="DATE OF BIRTH"/>
            </div>
            ...
            <div class="w-[100%]">
                <label class="px-[10px] text-secondary-color">SCHOOL:</label><br/>
                <select class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" id="faculty_id">
            ...
            <div class="w-[100%]">
                ...
                <select class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" id="department_id">
                    <script>
            ...
            <div class="w-[100%]">
                ...
                <select class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" id="programme_id">
                    <script>_get_programme();</script>
                </select>
            </div>

            <div class="w-[100%]">
                <label class="px-[10px] text-secondary-color">LEVEL:</label><br/>
                <select class="w-[100%] my-[10px] py-[15px] px-[20px] bg-white outline-none border-primary-color border-[1px] rounded-[5px]" id="level_id">
                    <script>_get_level();</script>
                </select>
            </div>
            
            <button class="w-[40%] bg-primary-color hover:bg-[#444444] text-white py-[15px] rounded-[5px]" title="Signup" id="submit_button" onclick="_add_new_student()">SIGN-UP <i class="bi-check2"></i></button>
        </div>
    </div>
