<?php if ($page=='resetPassword'){?>
   <div class="absolute w-[55%] min-h-[580px] bg-white top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 rounded-[5px] text-[12px] animated zoomIn">
        ...
        <div class="w-[90%] m-[auto]">
            ...
            <p class="bg-[#FCEDEA] py-[12px] px-[15px]"><span class="text-primary-color">OTP</span> not received? <span class="text-primary-color cursor-pointer" id="resendOTP" onclick="resendOTP('resendOTP', userId)"><i class="bi-send"></i> RESEND OTP</span></p>
            ...
            <button class="w-[100%] text-[15px]" title="confirm" id="submitButton" onclick="finishResetPassword(userId)"><i class="bi-check"></i> Reset Password</button>
        </div>
   </div>
<?php }?>