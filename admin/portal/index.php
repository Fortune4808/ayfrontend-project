...
<head>
	...
	<title><?php echo $websiteName;?> Administrative Login Portal</title>
		...
		<div class="w-[70%] h-[90px] bg-white/80 rounded-md" data-aos="zoom-in" data-aos-duration="2000">
			<div class="flex h-[90px] items-center ml-3 gap-3">
				...
				<div class="flex flex-col text-[#424141] font-body">
					<div><i class="bi-speedometer2"></i> <span id="loginDashboardRole">xxx</span> Dashboard</div>
					<div class="text-[14px] font-bold text-primary-color" id="loginStaffFullname"> XXX</div>
					<div class="text-[10px]">Last Login Date: <span id="loginStaffLastLogin">xxx</span></div>
				</div>
			</div>
